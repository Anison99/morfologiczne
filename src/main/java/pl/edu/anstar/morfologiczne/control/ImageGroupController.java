...
//		this.radioGroupController.mainController = this.parentController;
//		this.radioGroupController.imageGroupController = this;
	...
	public void reset() {
		...
		this.selectButton.setText((this.radioGroupController.isPolishSet()) ? SELECT_IMAGE_PL : SELECT_IMAGE_EN);
	}
